# Chocolate Factory Program - Unlimited Version
...
while operating_days > 7 || operating_days <= 0
  print "How many days per week is the factory open? "
  operating_days = Integer(gets.chomp)
end
